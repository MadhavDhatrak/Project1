...
const Calender = () => {
    const [toggleForm, setAppointmentData] = useState(false)

    return (
        <>
            <div>
                <button className="bg-blue-400 text-white px-2 py-3 w-full text-left rounded-t-md" onClick={() => setAppointmentData(!toggleForm)}>
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <textarea id="aptNotes" name="aptNotes" rows="3"
                                    className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-2 border-black rounded-md" placeholder="Detailed comments about the condition"></textarea>
                            </div>
                        </div>
